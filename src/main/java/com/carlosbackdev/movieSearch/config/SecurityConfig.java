        ...
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**") // Aplicar a todos los endpoints
                    .allowedOrigins("http://localhost:4200","https://localhost:8100","https://moviesearch.es", "https://moviesearchia.netlify.app","https://movisearchapi-production.up.railway.app") // Permitir solicitudes desde este origen
