        ...
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**") // Aplicar a todos los endpoints
                    .allowedOrigins("http://localhost:4200", "http://movisearchapi-production.up.railway.app","https://moviesearchia.netlify.app/home") // Permitir solicitudes desde este origen
